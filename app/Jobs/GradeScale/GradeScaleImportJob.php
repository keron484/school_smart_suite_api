...
class GradeScaleImportJob implements ShouldQueue
{
    ...
    public array $requiredFields = ['grade_title', 'exam_type', 'grade_max_score', 'max_score', 'min_score', 'resit_result', 'grade', 'result', 'performance'];
